...
syntax keyword junoKeyword for while if elif else break continue return yield import in and or self any
highlight link junoKeyword Keyword


syntax keyword junoType int int8 int16 int32 int64 uint8 uint16 uint32 uint64 float double char char8 char32 str
highlight link junoType Type

syntax keyword junoStorage bpnt fn exp
